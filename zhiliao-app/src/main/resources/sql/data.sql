...
-- 1. Departments
-- =============================================================================
-- All zl_department are root-level (parent_id = NULL) for MVP.
-- The UNIQUE (tenant_id, name) constraint prevents duplicate inserts.

INSERT INTO zl_department (name, parent_id, tenant_id)
...
INSERT INTO zl_user (username, password_hash, dept_id, role, tenant_id)
VALUES ('admin',    '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
        (SELECT id FROM zl_department WHERE name = '技术部' AND tenant_id = 'default'), 'ADMIN', 'default'),
       ('zhangsan', '$2a$10$.J9Dk5kBT0UQxYPfqYq3s.DGQPnwY3Y5GqYI71G2QrMnKN9JGKQTa',
        (SELECT id FROM zl_department WHERE name = '产品部' AND tenant_id = 'default'), 'USER',  'default'),
       ('lisi',     '$2a$10$.J9Dk5kBT0UQxYPfqYq3s.DGQPnwY3Y5GqYI71G2QrMnKN9JGKQTa',
        (SELECT id FROM zl_department WHERE name = '运营部' AND tenant_id = 'default'), 'USER',  'default')
